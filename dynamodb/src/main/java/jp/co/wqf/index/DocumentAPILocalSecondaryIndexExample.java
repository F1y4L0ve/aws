...
public class DocumentAPILocalSecondaryIndexExample {
	static DynamoDB dynamoDB = new DynamoDB(DynamoDBUtils.getDynamoDB());
	...
	public static void query(String indexName) {
		...
		if (indexName == "IsOpenIndex") {
			...
			querySpec.withKeyConditionExpression("CustomerId = :v_custid and OrderCreationDate >= :v_orddate")
					.withValueMap(new ValueMap().withString(":v_custid", "bob@example.com").withNumber(":v_orddate",
							20150131));
	...
	public static void loadData() {
		...
		item = new Item().withPrimaryKey("CustomerId", "bob@example.com").withNumber("OrderId", 4)
				...
				.withString("ProductCategory", "Hardware").withString("ProductName", "Extra Heavy Hammer")
